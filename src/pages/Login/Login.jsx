                  ...
                  Login
                                ...
                                <div className="flex ">
                                    <div className="mx-4 md:mx-0 btn-group btn-group-vertical lg:btn-group-horizontal ">
                                        <button onClick={handleGoogleSignIn} className="btn w-48 bg-zinc-300 hover:bg-blue-gray-200 border-0 text-black ">
                                            <div className="flex justify-center items-center gap-2 ">
                                                <Lottie animationData={google} className="h-12"   height={10} width={20} />

                                                <p onClick={handleGoogleSignIn} className="" >google</p>
                                            </div>
                                        </button>
